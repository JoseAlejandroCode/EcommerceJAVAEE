	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							...
							<p>Aprende a crear una tienda virtual con carrito de compras y pagos en linea con JSP, JAVA EE, AJAX, JavaScript y MySQL.</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright Â© 2019 . Todos los derechos reservados.</p>
					<p class="pull-right">Curso diseÃ±ado por <span><a target="_blank" href="https://www.udemy.com/user/christian-gamez-2">Christian Camilo GÃ¡mez</a></span></p>
				</div>
			</div>
		</div>
