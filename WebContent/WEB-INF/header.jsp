						...
						<div class="btn-group pull-right">
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="CambiarMoneda?moneda=MXN">Peso Mexicano   (MXN)</a></li>
									<li><a href="CambiarMoneda?moneda=COP">Peso Colombiano (COP)</a></li>
                                                                        
									<li><a href="CambiarMoneda?moneda=USD">Dolar EEUU      (USD)</a></li>
